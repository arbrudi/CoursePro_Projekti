...
Class Register extends Connection{
    public function registration($name, $surname, $email, $username, $password, $confirmpassword){
        ...
        if (mysqli_num_rows($duplicate)>0){
            ...
            $query="INSERT INTO user VALUES ('','$name','$surname','$username','$email','$password')";
...
class Login extends Connection{
  public $id;
  public function log($usernameemail, $password){
